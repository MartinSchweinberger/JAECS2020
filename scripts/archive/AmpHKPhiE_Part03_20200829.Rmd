...
```{r amphkpie_02_117, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_119, echo=T, eval = T, message=FALSE, warning=FALSE}
mf.glmer <- m21.glmer
mf.very <- m21.glmer
# compare models                
...
```{r amphkpie_02_121, echo=T, eval = T, message=FALSE, warning=FALSE}
library(sjPlot)
tab_model(mf.glmer)
```
...
```{r amphkpie_02_123, echo=T, eval = T, message=FALSE, warning=FALSE}
library(ggeffects)
...
```{r amphkpie_02_125, echo=T, eval = T, message=FALSE, warning=FALSE}
library(effects)
...
```{r amphkpie_02_127, echo=T, eval = T, message=FALSE, warning=FALSE}
library(gridExtra)
...
```{r amphkpie_02_129, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_131, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_133, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_135, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_137, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_139, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_141, echo=T, eval = T, message=FALSE, warning=FALSE}
summary(rndmlngtb$Intercept)
```

Publishable plot

```{r amphkpie_02_143, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_145, echo=T, eval = T, message=FALSE, warning=FALSE}
phi_really <- ice %>%
  ungroup() %>%
  filter(Corpus == "ICE-PHI") %>%
  mutate(Age = factor(Age),
...
```{r amphkpie_02_147, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_149, echo=T, eval = T, message=FALSE, warning=FALSE}
nrow(phi_really)
...
```{r amphkpie_02_151, echo=T, eval = T, message=FALSE, warning=FALSE}
library(rms)
library(lme4)
# set options
options(contrasts  =c("contr.treatment", "contr.poly"))
...
```{r amphkpie_02_153, echo=T, eval = T, message=FALSE, warning=FALSE}
m1.glmer <- update(m0.glmer, .~.+Age)
anova(m1.glmer, m0.glmer, test = "Chi")       
library(car)
Anova(m1.glmer, type = "III", test = "Chi")   
...
```{r amphkpie_02_155, echo=T, eval = T, message=FALSE, warning=FALSE}
m2.glmer <- update(m1.glmer, .~.+ Gender)
car::vif(m2.glmer)
anova(m2.glmer, m1.glmer, test = "Chi")       
Anova(m2.glmer, type = "III", test = "Chi")   
...
```{r amphkpie_02_157, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_159, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_161, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_163, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_165, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_167, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_169, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_171, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_173, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_175, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_177, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_179, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_181, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_183, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_185, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_187, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_189, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_191, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_193, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_195, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_197, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_199, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_201, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_203, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_205, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_207, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_209, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_211, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_213, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_215, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_217, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_219, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_221, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_223, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_225, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_227, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_229, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_231, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_233, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_235, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_237, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_239, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_241, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_243, echo=T, eval = T, message=FALSE, warning=FALSE}
# find all 2-way interactions
library(utils)
#colnames(pphi)
# define variables included in interactions
...
```{r amphkpie_02_245, echo=T, eval = T, message=FALSE, warning=FALSE}
check_models <- function(int3w) {
  rslt <- sapply(int3w, function(x){
...
```{r amphkpie_02_247, echo=T, eval = T, message=FALSE, warning=FALSE}
mf.glmer <- m25.glmer
mf.really <- m25.glmer
# compare models                
anova(mf.glmer, m0.glmer, test = "Chi")
...
```{r amphkpie_02_249, echo=T, eval = T, message=FALSE, warning=FALSE}
library(sjPlot)
tab_model(mf.glmer)
```
...
```{r amphkpie_02_251, echo=T, eval = T, message=FALSE, warning=FALSE}
library(ggeffects)
effectsdf <- ggeffect(mf.glmer)
# inspect effects
effectsdf
...
```{r amphkpie_02_253, echo=T, eval = T, message=FALSE, warning=FALSE}
library(effects)
...
```{r amphkpie_02_255, echo=T, eval = T, message=FALSE, warning=FALSE}
library(gridExtra)
p1 <- plot_model(mf.glmer, type = "pred", terms = c("Age"))
p2 <- plot_model(mf.glmer, type = "pred", terms = c("Function"))
...
```{r amphkpie_02_257, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_259, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_261, echo=T, eval = T, message=FALSE, warning=FALSE}
randomtb <- ranef(mf.glmer)$Adjective
rndmlngtb <- data.frame(rownames(randomtb), randomtb)
colnames(rndmlngtb) <- c("Adjective", "Intercept")
rndmlngtb <- rndmlngtb[order(rndmlngtb$Intercept, decreasing = T),]
...
```{r amphkpie_02_263, echo=T, eval = T, message=FALSE, warning=FALSE}
summary(rndmlngtb$Intercept)
```

Publishable plot

```{r amphkpie_02_265, echo=T, eval = T, message=FALSE, warning=FALSE}
ggplot(rndmlngtb, aes(Adjective, Intercept)) +
  geom_point(aes(reorder(Adjective, -Intercept, fun = Intercept), y=Intercept)) +
  coord_cartesian(ylim = c(-1, 2)) +
  theme_set(theme_bw(base_size = 12)) +
...
```{r amphkpie_02_267, echo=T, eval = T, message=FALSE, warning=FALSE}
phi_so <- ice %>%
  ungroup() %>%
  filter(Corpus == "ICE-PHI") %>%
  mutate(Age = factor(Age),
...
```{r amphkpie_02_269, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_271, echo=T, eval = T, message=FALSE, warning=FALSE}
nrow(phi_so)
phi_so <- phi_so %>%
  select(-Corpus, -EducationLevel, -Ethnicity) %>%
  na.omit()
...
```{r amphkpie_02_273, echo=T, eval = T, message=FALSE, warning=FALSE}
library(rms)
library(lme4)
# set options
options(contrasts  =c("contr.treatment", "contr.poly"))
...
```{r amphkpie_02_275, echo=T, eval = T, message=FALSE, warning=FALSE}
m1.glmer <- update(m0.glmer, .~.+Age)
anova(m1.glmer, m0.glmer, test = "Chi")       
library(car)
Anova(m1.glmer, type = "III", test = "Chi")   
...
```{r amphkpie_02_277, echo=T, eval = T, message=FALSE, warning=FALSE}
m2.glmer <- update(m1.glmer, .~.+ Gender)
car::vif(m2.glmer)
anova(m2.glmer, m1.glmer, test = "Chi")       
Anova(m2.glmer, type = "III", test = "Chi")   
...
```{r amphkpie_02_279, echo=T, eval = T, message=FALSE, warning=FALSE}
m3.glmer <- update(m2.glmer, .~.+Function)
car::vif(m3.glmer)
anova(m3.glmer, m1.glmer, test = "Chi")       
Anova(m3.glmer, type = "III", test = "Chi")   
...
```{r amphkpie_02_281, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_283, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_285, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_287, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_289, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_291, echo=T, eval = T, message=FALSE, warning=FALSE}
m9.glmer <- update(m8.glmer, .~.+ Emotionality)
car::vif(m9.glmer)
anova(m9.glmer, m8.glmer, test = "Chi") 
...
```{r amphkpie_02_293, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_295, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_297, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_301, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_303, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_305, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_307, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_309, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_311, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_313, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_315, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_317, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_319, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_321, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_323, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_325, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_327, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_329, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_331, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_333, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_337, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_339, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_341, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_343, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_345, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_347, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_349, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_351, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_353, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_355, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_357, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_359, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_361, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_363, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_365, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_367, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_369, echo=T, eval = T, message=FALSE, warning=FALSE}
# find all 2-way interactions
library(utils)
#colnames(pphi)
# define variables included in interactions
...
```{r amphkpie_02_371, echo=T, eval = T, message=FALSE, warning=FALSE}
check_models <- function(int3w) {
  rslt <- sapply(int3w, function(x){
...
```{r amphkpie_02_381, echo=T, eval = T, message=FALSE, warning=FALSE}
mf.glmer <- m19.glmer
mf.so <- m19.glmer
# compare models                
anova(mf.glmer, m0.glmer, test = "Chi")
...
```{r amphkpie_02_383, echo=T, eval = T, message=FALSE, warning=FALSE}
library(sjPlot)
tab_model(mf.glmer)
```
...
```{r amphkpie_02_385, echo=T, eval = T, message=FALSE, warning=FALSE}
library(ggeffects)
effectsdf <- ggeffect(mf.glmer)
# inspect effects
effectsdf
...
```{r amphkpie_02_387, echo=T, eval = T, message=FALSE, warning=FALSE}
library(effects)
...
```{r amphkpie_02_389, echo=T, eval = T, message=FALSE, warning=FALSE}
library(gridExtra)
...
```{r amphkpie_02_391, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_393 echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_395, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_397, echo=T, eval = T, message=FALSE, warning=FALSE}
...
```{r amphkpie_02_399, echo=T, eval = T, message=FALSE, warning=FALSE}
randomtb <- ranef(mf.glmer)$Adjective
rndmlngtb <- data.frame(rownames(randomtb), randomtb)
colnames(rndmlngtb) <- c("Adjective", "Intercept")
rndmlngtb <- rndmlngtb[order(rndmlngtb$Intercept, decreasing = T),]
