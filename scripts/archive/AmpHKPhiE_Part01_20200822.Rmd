...
```{r amphkpie_01_67, echo=T, eval = F, message=FALSE, warning=FALSE}
iceamp <- iceamp %>%
  mutate(Function = ifelse(Variant == "so", "Predicative", Function)) %>%
  mutate(Function = ifelse(Variant == "so" & Corpus == "ICE-HK" & File == "S1A-022" & Id == "248", "Attributive", 
                    ifelse(Variant == "so" & Corpus == "ICE-HK" & File == "S1A-080" & Id == "982", "Attributive",       
                    ifelse(Variant == "so" & Corpus == "ICE-HK" & File == "S1A-087" & Id == "148", "Attributive",       
                    ifelse(Variant == "so" & Corpus == "ICE-HK" & File == "S1A-096" & Id == "1240", "Attributive",       
                    ifelse(Variant == "so" & Corpus == "ICE-IND" & File == "S1A-022" & Id == "135", "Attributive",       
                    ifelse(Variant == "so" & Corpus == "ICE-IND" & File == "S1A-048" & Id == "94", "Attributive",       
                    ifelse(Variant == "so" & Corpus == "ICE-IND" & File == "S1A-065" & Id == "298", "Attributive",       
                   ifelse(Variant == "so" & Corpus == "ICE-IND" & File == "S1A-066" & Id == "308", "Attributive",        
                   ifelse(Variant == "so" & Corpus == "ICE-IND" & File == "S1A-092" & Id == "403", "Attributive", Function)))))))))) %>%
  filter(Id == "1312" & Corpus == "ICE-HK" & File == "S1A-100",
         Id == "17" & Corpus == "ICE-IND" & File == "S1A-002",
         Id == "19" & Corpus == "ICE-IND" & File == "S1A-003",
         Id == "36" & Corpus == "ICE-IND" & File == "S1A-004",
         Id == "13" & Corpus == "ICE-IND" & File == "S1A-012",
         Id == "16" & Corpus == "ICE-IND" & File == "S1A-012",
         Id == "20" & Corpus == "ICE-IND" & File == "S1A-015",
         Id == "28" & Corpus == "ICE-IND" & File == "S1A-020",
         Id == "235" & Corpus == "ICE-IND" & File == "S1A-043",
         Id == "288" & Corpus == "ICE-IND" & File == "S1A-064",
         Id == "327" & Corpus == "ICE-IND" & File == "S1A-069",
         Id == "254" & Corpus == "ICE-IND" & File == "S1A-090",
         Id == "15" & Corpus == "ICE-PHI" & File == "S1A-004",
         Id == "31" & Corpus == "ICE-PHI" & File == "S1A-036",
         Id == "272" & Corpus == "ICE-PHI" & File == "S1A-046",
         Id == "273" & Corpus == "ICE-PHI" & File == "S1A-046",
         Id == "152" & Corpus == "ICE-PHI" & File == "S1A-073")
# save raw data to disc
write.table(iceamp, 
